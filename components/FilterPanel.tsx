...
const FilterPanel: React.FC<FilterPanelProps> = ({ onSimulate, isLoading }) => {
  const skincarePresets = procedures.filter(p => p.tipo === 'skincare');
